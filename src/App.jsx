...
function App() {
  ...
  return (
    <div style={{ width: "100%", display: "flex", flexDirection: "column", alignItems: "center", justifyContent:"center" }}>
      <ul style={{ listStyleType: "none", padding: 0, width: "100%", maxWidth: 600 }}>
        {users && users.map((user) => (
          <li key={user.id} style={{ marginBottom: 20, padding: 10, border: "1px solid #ccc", display: "flex", alignItems: "center" }}>
